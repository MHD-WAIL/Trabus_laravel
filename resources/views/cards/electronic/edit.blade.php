...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 class="text-uppercase">electronic card transaction</h2>
            </div>
    ...
    <form action="{{ url('el-withdraw')}}" method="post" class="mt-3">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" id="card_number" name="card_number" value="{{ $card->number }}"
