...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="/main_dash/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="/main_dash/assets/img/favicon.png">
    <title>
        Trabus dashboard
    </title>
    <!--     Fonts and icons     -->
    ...
    <!-- Nucleo Icons -->
    <link href="/main_dash/assets/css/nucleo-icons.css" rel="stylesheet"/>

    <link href="/main_dash/assets/css/nucleo-icons.css" rel="stylesheet"/>

    <link href="/main_dash/assets/css/nucleo-svg.css" rel="stylesheet"/>
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="sources/main_dash/assets/css/nucleo-svg.css" rel="stylesheet"/>
    <!-- CSS Files -->
    <link id="pagestyle" href="/main_dash/assets/css/soft-ui-dashboard.css?v=1.0.1" rel="stylesheet"/>
</head>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="../pages/dashboard.html">
            <img src="{{asset('/main_dash/assets/img/logo-ct.png')}}
            {{--                ./app/resources/main_dash/assets/img/logo-ct.png--}}
                " class="navbar-brand-img h-100 w-15" alt="...">
            <span class="ms-1 font-weight-bold"> Trabus dashboard</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="{{url('dashboard')}}">
                    <div
                        class=" icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{url('blue')}}">
                    <div
                    ...
                    <span class="nav-link-text ms-1">Blue Cards</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{url('istanbul')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Istanbul Cards</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{url('electronic')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Electronic Card</span>
                </a>
            </li>
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background"
                 style="background-image: url('/main_dash/assets/img/curved-images/white-curved.jpeg')"></div>
...
<main class="main-content mt-1 border-radius-lg">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4"
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="/main_dash/assets/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                                        </div>
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="/main_dash/assets/img/small-logos/logo-spotify.svg"
    ...
    {{--                                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">MHD--}}
    {{--                                    WAIL</a>--}}
    {{--                                for TRABUS Comany.--}}
    {{--                            </div>--}}
    {{--                        </div>--}}
...
<!--   Core JS Files   -->
<script src="/main_dash/assets/js/core/popper.min.js"></script>
<script src="/main_dash/assets/js/core/bootstrap.min.js"></script>
<script src="/main_dash/assets/js/plugins/smooth-scrollbar.min.js"></script>
<!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
<script src="/main_dash/assets/js/soft-ui-dashboard.min.js?v=1.0.1"></script>
<script src="/main_dash/assets/js/plugins/chartjs.min.js"></script>
<script src="/main_dash/assets/js/plugins/Chart.extension.js"></script>
<script>
